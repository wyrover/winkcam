...
module.exports = (function(){
	...
	var imageOutput = __dirname + '/image24.jpg'; //Output file

	var faceImgFile = __dirname + '/faceImg.png'; //Input file
	var itemList = require(__dirname + "/items.js"); //database of props

	var instagramRes = 640; //resolution of imageOutput. igerslike only accepts 640x640
	...
	var fs = require('fs');
	var images = require("images"); //https://www.npmjs.com/package/images
	...
	_mainFaceImage()
		...
		.then(function(){ return _saveImage();})
	...
	function _saveImage(){
    	...
    	return new Promise(function(resolve, reject) {
			...
			fs.writeFile(imageOutput, buf, function(){
				...
				//Convert image so that Igerslike accept the image...
				images(imageOutput)    //Load image from file
			    .save(imageOutput, {   //Save the image to a file
			        quality : 75
			    });

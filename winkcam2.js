...
var imageOutput = __dirname + '/image16.png'

var faceImgFile = '/Users/davidlung/Documents/winkcam/justin.png'
var itemImgFile = '/Users/davidlung/Documents/winkcam/photobooth/eyes/glasses_stars.png'
		...
		fs.readFile(faceImgFile, function(err, image1buffer){
			...
			fs.readFile(itemImgFile, function(err, image2buffer){
				...
				for (var i=0; i<faces.length; i++){
					...
					var distEyes = Math.sqrt(Math.pow(rightEye.x-leftEye.x,2)+Math.pow(rightEye.y-leftEye.y,2))*canvasFacefactor
					...
					var itemW = img2.width*(2*distEyes/img2.width);
					var itemH = img2.height*(2*distEyes/img2.width);
					...
					ctx.drawImage(img2,
						leftEye.x*canvasFacefactor-0.25*itemW,  	//x = faceX - dx
						leftEye.y*canvasFacefactor-0.5*itemH, 		//y = faceY - dy
						itemW, 						//itemW
						itemH						//itemH
					);
